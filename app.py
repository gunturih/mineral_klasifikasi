...
# st.title('Iini adalah title')
# st.write('ini adalah stremlit baru')
# nama = st.text_input('Masukkan nama anda')
# usia = st.slider('pilih usia anda', 1, 100)
...
#cek library terpasang sebelum melanjutkan
if cek_library():
        ...
        if st.button("Deteksi Gambar"):
            with st.spinner("Sedang memproses..."):
                try:
                    ...
                    #taampilkan hasil
                    st.write(f"Objek yang terdeteksi adalah {objek_terdeteksi}")
...
st.markdown(
    ...
    "<div style='text-align: center;' class='footer'>Program Aplikasi deteksi batuan @2025</div>", unsafe_allow_html=True
)
